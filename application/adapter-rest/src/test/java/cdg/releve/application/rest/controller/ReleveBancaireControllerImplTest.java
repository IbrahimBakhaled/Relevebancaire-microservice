...
import cdg.releve.application.rest.mapper.ReleveBancaireEntityMapper;
...
class ReleveBancaireControllerImplTest {
    ...
    @MockBean
    private ReleveBancaireEntityMapper mapper;
    ...
    private ReleveBancaire createMockModel(){
     ...
     private  ReleveBancaireCreationRequest createMockResponse(){
